...
public class GetStudentTempByIdQueryHandler
    : IRequestHandler<GetStudentTempByIdQuery, EpvoStudentTempDto?>
{
    private readonly IEpvoSsoRepository<Student_Temp> _repository;

    public GetStudentTempByIdQueryHandler(IEpvoSsoRepository<Student_Temp> repository)
    {
        _repository = repository;
    }

    public async Task<EpvoStudentTempDto?> Handle(
        GetStudentTempByIdQuery request, CancellationToken cancellationToken)
    {
