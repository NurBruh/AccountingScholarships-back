...
public class GetAllStudentTempsQueryHandler
    : IRequestHandler<GetAllStudentTempsQuery, IReadOnlyList<EpvoStudentTempDto>>
{
    private readonly IEpvoSsoRepository<Student_Temp> _repository;

    public GetAllStudentTempsQueryHandler(IEpvoSsoRepository<Student_Temp> repository)
    {
        _repository = repository;
    }

    public async Task<IReadOnlyList<EpvoStudentTempDto>> Handle(
        GetAllStudentTempsQuery request, CancellationToken cancellationToken)
    {
        var entities = await _repository.GetAllAsync(cancellationToken);
        return entities.Select(s => new EpvoStudentTempDto
        {
