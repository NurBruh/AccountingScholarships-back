...
public class GetAllStudentSsoQueryHandler
    : IRequestHandler<GetAllStudentSsoQuery, IReadOnlyList<EpvoStudentSsoDto>>
{
    private readonly IEpvoSsoRepository<Student_Sso> _repository;

    public GetAllStudentSsoQueryHandler(IEpvoSsoRepository<Student_Sso> repository)
    {
        _repository = repository;
    }

    public async Task<IReadOnlyList<EpvoStudentSsoDto>> Handle(
        GetAllStudentSsoQuery request, CancellationToken cancellationToken)
    {
